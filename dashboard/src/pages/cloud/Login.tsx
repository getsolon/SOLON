...
export default function Login() {
  ...
  return (
    <>
      <h2 className="text-lg font-semibold text-[var(--text)] mb-2">Sign in to Solon</h2>
      <p className="text-sm text-[var(--text-secondary)] mb-6">Continue with your GitHub or Google account.</p>

      <div className="space-y-3">
        <a href={oauthHref('github')} className="block" {...(desktop ? { target: '_blank', rel: 'noopener noreferrer' } : {})}>
        ...
        <a href={oauthHref('google')} className="block" {...(desktop ? { target: '_blank', rel: 'noopener noreferrer' } : {})}>
          <Button variant="secondary" className="w-full pointer-events-none">
