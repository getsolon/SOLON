...
const features = [
  {
    ...
    description:
      "Every instance runs in its own isolated environment with dedicated resources, network segmentation, and strict access controls.",
    icon: (
  ...
  {
    title: "Multi-Tier Inference",
    description:
      "Route requests across local GPU models, cloud APIs, or hybrid configurations. Solon handles fallback, load balancing, and cost optimization.",
    icon: (
      <svg className="h-8 w-8 text-indigo-500" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
  ...
  },
  {
    ...
    description:
      "API keys encrypted at rest, automatic TLS via Caddy, SSH hardening, firewall rules, and optional WAF on Pro and GPU tiers.",
    icon: (
      <svg className="h-8 w-8 text-indigo-500" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
  ...
  },
  {
    ...
    description:
      "Provision a fully configured Solon instance in minutes. Terraform + Ansible handle infrastructure while you focus on building.",
    icon: (
      <svg className="h-8 w-8 text-indigo-500" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        ...
        <div className="mx-auto max-w-7xl px-4 py-24 sm:px-6 sm:py-32 lg:px-8">
          <div className="text-center">
            <h1 className="text-5xl font-bold tracking-tight text-gray-900 sm:text-6xl">
              Managed{" "}
              <span className="text-indigo-600">Solon</span>{" "}
              Hosting
            </h1>
            <p className="mx-auto mt-6 max-w-2xl text-lg leading-8 text-gray-600">
              Deploy production-grade AI inference infrastructure in minutes.
              Tenant isolation, automatic TLS, multi-tier model routing, and
              GPU acceleration -- all managed for you.
            </p>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h2 className="text-3xl font-bold tracking-tight text-gray-900">
              Everything you need for AI inference
            </h2>
            <p className="mt-4 text-lg text-gray-600">
              Built on Solon, hardened for production.
            </p>
          </div>
              ...
              >
                <h3
                  className={`text-lg font-semibold ${
                    tier.highlighted ? "text-indigo-100" : "text-indigo-600"
                  }`}
                >
                  {tier.name}
                </h3>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between">
            ...
            <p className="text-sm text-gray-400">
              Managed Solon hosting by NemoClaw.
            </p>
          </div>
        </div>
      </footer>
